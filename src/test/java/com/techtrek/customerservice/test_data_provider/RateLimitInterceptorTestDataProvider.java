...
public class RateLimitInterceptorTestDataProvider {
    ...
    public static HttpServletRequest buildRequestWithOutAuthorizationHeader() {
        return new HttpServletRequest() {
            ...
            @Override
            public String getHeader(String s) {
                if (s.equals(HEADER_LIMIT_REMAINING))
                    return "0";
                else
                    return null;
            }
            ...
            @Override
            public Enumeration<String> getHeaderNames() {
                return Collections.enumeration(List.of(HEADER_LIMIT_REMAINING));
            }
    ...
    public static HttpServletResponse buildResponse() {
